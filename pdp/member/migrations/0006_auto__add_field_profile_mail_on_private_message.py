...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.mail_on_private_message'
        db.add_column('member_profile', 'mail_on_private_message',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.mail_on_private_message'
        db.delete_column('member_profile', 'mail_on_private_message')
    ...
    models = {
        ...
        'member.activationtoken': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'member.profile': {
            ...
            'avatar_url': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '128', 'blank': 'True'}),
            'biography': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail_on_private_message': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
