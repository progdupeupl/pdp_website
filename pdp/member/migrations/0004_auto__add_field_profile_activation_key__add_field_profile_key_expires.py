...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'member_profile', 'activation_key')

        # Deleting field 'Profile.key_expires'
        db.delete_column(u'member_profile', 'key_expires')
    ...
    models = {
        ...
        u'member.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 13, 0, 0)'}),
