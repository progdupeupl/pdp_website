...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chapter.tutoriel'
        db.delete_column('tutorial_chapter', 'tutoriel_id')

        # Adding field 'Chapter.tutorial'
        db.add_column('tutorial_chapter', 'tutorial',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorial.Tutorial'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Chapter.tutoriel'
        db.add_column('tutorial_chapter', 'tutoriel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorial.Tutorial'], null=True),
                      keep_default=False)

        # Deleting field 'Chapter.tutorial'
        db.delete_column('tutorial_chapter', 'tutorial_id')
