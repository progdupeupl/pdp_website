...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tutorial_tutorialcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=80)),
        ))
        db.send_create_signal(u'tutorial', ['TutorialCategory'])

        # Adding field 'Tutorial.category'
        db.add_column(u'tutorial_tutorial', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorial.TutorialCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TutorialCategory'
        db.delete_table(u'tutorial_tutorialcategory')

        # Deleting field 'Tutorial.category'
        db.delete_column(u'tutorial_tutorial', 'category_id')
