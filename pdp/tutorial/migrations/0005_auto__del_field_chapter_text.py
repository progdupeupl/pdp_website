...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chapter.text'
        db.delete_column('tutorial_chapter', 'text')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Chapter.text'
        raise RuntimeError("Cannot reverse this migration. 'Chapter.text' and its values cannot be restored.")
