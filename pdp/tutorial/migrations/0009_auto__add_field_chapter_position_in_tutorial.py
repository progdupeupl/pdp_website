...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.position_in_tutorial'
        db.add_column('tutorial_chapter', 'position_in_tutorial',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.position_in_tutorial'
        db.delete_column('tutorial_chapter', 'position_in_tutorial')
