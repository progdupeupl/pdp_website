...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Part.position_in_tutorial'
        db.alter_column(u'tutorial_part', 'position_in_tutorial', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Part.position_in_tutorial'
        db.alter_column(u'tutorial_part', 'position_in_tutorial', self.gf('django.db.models.fields.IntegerField')(default=0))
