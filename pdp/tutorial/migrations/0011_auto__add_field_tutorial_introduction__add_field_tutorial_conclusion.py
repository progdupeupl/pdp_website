...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tutorial_tutorial', 'introduction',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tutorial.conclusion'
        db.add_column('tutorial_tutorial', 'conclusion',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tutorial_tutorial', 'introduction')

        # Deleting field 'Tutorial.conclusion'
        db.delete_column('tutorial_tutorial', 'conclusion')
