...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chapter.slug'
        db.alter_column(u'tutorial_chapter', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))

        # Changing field 'Tutorial.pubdate'
        db.alter_column(u'tutorial_tutorial', 'pubdate', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Tutorial.slug'
        db.alter_column(u'tutorial_tutorial', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))

        # Changing field 'Part.slug'
        db.alter_column(u'tutorial_part', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'Chapter.slug'
        db.alter_column(u'tutorial_chapter', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Tutorial.pubdate'
        db.alter_column(u'tutorial_tutorial', 'pubdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Tutorial.slug'
        db.alter_column(u'tutorial_tutorial', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Part.slug'
        db.alter_column(u'tutorial_part', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
