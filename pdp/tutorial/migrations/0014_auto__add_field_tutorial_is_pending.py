...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.is_pending'
        db.add_column(u'tutorial_tutorial', 'is_pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.is_pending'
        db.delete_column(u'tutorial_tutorial', 'is_pending')
