...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.pubdate'
        db.add_column('tutorial_tutorial', 'pubdate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 26, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.pubdate'
        db.delete_column('tutorial_tutorial', 'pubdate')
    ...
    models = {
        ...
        'tutorial.tutorial': {
            ...
            'pubdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        }
    }
