...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tutorial_chapter', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='undefined', max_length=50),
                      keep_default=False)

        # Adding field 'Tutorial.slug'
        db.add_column('tutorial_tutorial', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='undefined', max_length=50),
                      keep_default=False)

        # Adding field 'Part.slug'
        db.add_column('tutorial_part', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='undefined', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tutorial_chapter', 'slug')

        # Deleting field 'Tutorial.slug'
        db.delete_column('tutorial_tutorial', 'slug')

        # Deleting field 'Part.slug'
        db.delete_column('tutorial_part', 'slug')
