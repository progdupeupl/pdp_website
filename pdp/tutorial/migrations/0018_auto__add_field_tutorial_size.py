...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.size'
        db.add_column(u'tutorial_tutorial', 'size',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.size'
        db.delete_column(u'tutorial_tutorial', 'size')
    ...
    models = {
        ...
        u'tutorial.tutorial': {
            ...
            'is_mini': ('django.db.models.fields.BooleanField', [], {}),
