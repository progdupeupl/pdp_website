...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.is_pending'
        db.add_column(u'article_article', 'is_pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.is_pending'
        db.delete_column(u'article_article', 'is_pending')
