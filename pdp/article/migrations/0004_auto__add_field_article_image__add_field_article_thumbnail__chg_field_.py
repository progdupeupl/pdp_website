...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'article_article', 'pubdate', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Article.pubdate'
        db.alter_column(u'article_article', 'pubdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
