...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'article_articlecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=80)),
        ))
        db.send_create_signal(u'article', ['ArticleCategory'])

        # Adding field 'Article.category'
        db.add_column(u'article_article', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['article.ArticleCategory'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ArticleCategory'
        db.delete_table(u'article_articlecategory')
    ...
    models = {
        u'article.article': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['article.ArticleCategory']", 'null': 'True'}),
